...
export default function Analytics() {
  ...
  const hourlyData = [
    { hour: "6AM", orders: 4, revenue: 1240 },
    { hour: "7AM", orders: 8, revenue: 2340 },
    { hour: "8AM", orders: 12, revenue: 3600 },
    { hour: "9AM", orders: 18, revenue: 5420 },
    { hour: "10AM", orders: 25, revenue: 7200 },
    { hour: "11AM", orders: 32, revenue: 9100 },
    { hour: "12PM", orders: 48, revenue: 14400 },
    { hour: "1PM", orders: 55, revenue: 16200 },
    { hour: "2PM", orders: 42, revenue: 12800 },
    { hour: "3PM", orders: 28, revenue: 8400 },
    { hour: "4PM", orders: 22, revenue: 6600 },
    { hour: "5PM", orders: 35, revenue: 10500 },
    { hour: "6PM", orders: 52, revenue: 15600 },
    { hour: "7PM", orders: 68, revenue: 20400 },
    { hour: "8PM", orders: 75, revenue: 22500 },
    { hour: "9PM", orders: 62, revenue: 18600 },
    ...
    <div style={{ minHeight: "100vh", background: "#0a0a0f", color: "white", fontFamily: "-apple-system, BlinkMacSystemFont, sans-serif" }}>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "24px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16, marginBottom: 24 }}>
          {[
            { label: "Total Revenue", value: "₹2,34,580", change: "+18.3%", up: true, icon: "💰", color: "#22c55e" },
            { label: "Orders", value: "1,847", change: "+12.5%", up: true, icon: "📦", color: "#3b82f6" },
            { label: "Avg Order Value", value: "₹412", change: "+5.2%", up: true, icon: "🛒", color: "#e85d04" },
            { label: "Delivery Time", value: "22 min", change: "-8.1%", up: true, icon: "⏱️", color: "#a855f7" },
          ].map((kpi, i) => (
        ...
        <div style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 16, padding: 24, marginBottom: 24 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
            ...
            <span style={{ fontSize: 12, color: "#888" }}>Peak hours: 7-9 PM</span>
          </div>
