                    ...
                    <div style={{
                      ...
                      <div style={{ position: "relative", height: 60, background: "rgba(0,0,0,0.04)", borderRadius: 8, overflow: "hidden" }}>
                        ...
                        <svg style={{ position: "absolute", inset: 0, width: "100%", height: "100%", pointerEvents: "none" }} viewBox="0 0 100 60" preserveAspectRatio="none">
                          <path d={`M ${5} ${30} Q ${30} ${activeOrder.status === "out-for-delivery" ? 25 + Math.sin(Date.now() / 500) * 5 : 30} ${Math.max(10, Math.min(85, 100 - activeOrder.eta * 4 - 8))} ${30}`} stroke="rgba(232,93,4,0.2)" strokeWidth="1" fill="none" strokeDasharray="3,3" />
